...
resource "azurerm_linux_web_app" "webapp" {
  ...
  app_settings = {
    "ASPNETCORE_CONNECTIONSTRINGS__DEFAULTCONNECTION" : "User ID=stronzo;Password=${azurerm_postgresql_flexible_server.databaseserver.administrator_password};Host=${azurerm_postgresql_flexible_server.databaseserver.fqdn};Port=5432;Database=postgres;Include Error Detail=true"
  }
}
